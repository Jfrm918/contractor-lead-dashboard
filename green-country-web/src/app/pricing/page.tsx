...
const tiers = [
  ...
  },
  {
    ...
    price: "$2,500",
    sub: "One-time · 50% deposit",
    blurb: "Multi-page + one integration. Booking widget OR Stripe checkout OR multi-location pages — pick one. Heavier custom work is quoted separately.",
    features: [
      "5-8 page custom design",
      "Mobile + desktop responsive",
      "One integration: booking, payments, or multi-location",
      "Email automation hookup (Mailchimp / ConvertKit)",
