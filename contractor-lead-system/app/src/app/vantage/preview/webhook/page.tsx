...
import { WebhookPreview, PREVIEW_TABS } from '../../_components/previews';
import { VantageAtmosphere, VantagePreviewNav } from '../../_components/shell';

export default function WebhookPreviewPage() {
  return (
        ...
        <main className="mx-auto max-w-6xl px-6 py-10 sm:py-14">
          <header className="max-w-2xl">
            ...
            <h1 className="mt-3 text-balance text-4xl font-semibold tracking-[-0.03em] text-white sm:text-[44px]">
              Every new permit, posted straight to your CRM.
            </h1>
            <p className="mt-4 text-[15px] leading-[1.6] text-zinc-300/85">
              Within five minutes of any matching permit. Plug in HubSpot, Salesforce, Pipedrive,
              Zapier, Slack, or your own endpoint. Sample JSON below.
            </p>
          </header>
          ...
          <div className="mt-10 glass-frosted glass-textured overflow-hidden">
            ...
            <div className="relative z-10">
              <RoutedTabs
                ...
                active="/vantage/preview/webhook"
              />
              <WebhookPreview />
            </div>
          </div>
